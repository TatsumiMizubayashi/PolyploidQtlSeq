namespace PolyploidQtlSeq.Options.QualityControl
{
    ...
    public interface IFastpQualityControlOptionValue
    {
        ...
        /// <summary>
        /// FastpQualityControlSettingValueを作成する。
        /// </summary>
        /// <returns>FastpQualityControlSettingValue</returns>
        internal FastpQualityControlSettingValueDTO CreateFastpQualityControlSettingValue()
        {
            return new FastpQualityControlSettingValueDTO()
            {
                InputDir = InputDir,
                OutputDir = OutputDir,
